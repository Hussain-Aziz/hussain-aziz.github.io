  ...
  return (
    <div>
      ...
      <div className="body-container">
        ...
        <img src={AdminDashbord_Map} alt='AdminDashbord_Map' className="display-image"/>
        <p>
        ...
        <img src={AdminDashbord_UserManagement} alt='AdminDashbord_UserManagement' className="display-image"/>
      </div>
    </div>
  );
}
